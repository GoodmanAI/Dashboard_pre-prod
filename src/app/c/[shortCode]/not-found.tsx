/**
 * Page 404 dediee au sous-domaine rdv.neuracorp.ai.
 *
 * Declenchee par notFound() dans [shortCode]/page.tsx quand :
 *   - Le shortCode est absent, trop court ou trop long
 *   - Le shortCode n'existe pas en base (lien errone, ou purge de retention)
 *
 * Jusqu'au 2026-08-11 cette route n'avait AUCUN not-found.tsx : le patient
 * tombait sur la 404 par defaut de Next.js, sans un mot expliquant quoi faire.
 * Calque sur celui de /d/[shortCode], meme raisonnement :
 *
 ...
 * HTTP 200 au lieu du 404 attendu. En server component avec styling inline,
 * on garantit :
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Ce lien de confirmation n&apos;est pas valide, ou il a expire. Verifiez
          le lien recu par SMS, ou contactez directement votre centre
          d&apos;imagerie pour confirmer ou annuler votre rendez-vous.
        </p>
